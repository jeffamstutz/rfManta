...
#define MULTI_HIT_VALIDATE

// Primary rays ///////////////////////////////////////////////////////////////

#ifdef MULTI_HIT_VALIDATE

#define RF_CONTINUE  return 1
#define RF_TERMINATE return 0
...
RF_INLINE int rfHitFcn(rfRayData* rayData,
                       void*      modeldata,
                       void*      objectdata,
                       float*     dir,
                       float*     hitpt,
                       ...
                       float*     matrix)
{
  if(hitdist > rayData->skipdist)
  {
    ...
    rayData->normal[0] = normal[0];
    rayData->normal[1] = normal[1];
    rayData->normal[2] = normal[2];
    RF_TERMINATE;
  }
  else
    RF_CONTINUE;
